  ...
  run() {
    const makeMusic = () => {
      ...
      let Sounds = [null,
        ...
        [
          randSound(28, 'Bass (*).WAV'),
          randSound(28, 'Bass (*).WAV'),
          randSound(42, 'Drums (*).WAV'),
          randSound(42, 'Drums (*).WAV'),
          randSound(21, 'Keys (*).WAV'),
          randSound(21, 'Keys (*).WAV'),
          randSound(49, 'Perc (*).WAV'),
          randSound(49, 'Perc (*).WAV'),
          randSound(34, 'Seq (*).WAV'),
          randSound(34, 'Seq (*).WAV'),
          randSound(35, 'Synth (*).WAV'),
          randSound(35, 'Synth (*).WAV'),
          randSound(56, 'Guitar (*).WAV'),
          randSound(56, 'Guitar (*).WAV'),
        ],
        [
          randSound(24, 'Bass (*).WAV'),
          randSound(24, 'Bass (*).WAV'),
